...
import { 
  ...
  ArrowUpRight, ListTodo, Plus, Shield
} from "lucide-react";
  ...
  return (
    <div className="flex-1 overflow-y-auto p-8 custom-scrollbar h-full">
      <div className="max-w-7xl mx-auto space-y-8 pb-12">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/50 pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1 max-w-xl">{project.description || "Painel de controle com estatísticas e acompanhamento em tempo real."}</p>
            </div>
          </div>
        </header>
        ...
        {/* Detailed Grid (Boards vs Members) */}
          ...
          <div className="lg:col-span-2 bg-card border border-border p-6 rounded-3xl shadow-sm space-y-6">
            ...
            {boards.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center border border-dashed border-border rounded-2xl">
                ...
                <p className="text-xs text-muted-foreground mt-1 max-w-xs">Crie o seu primeiro quadro dentro do projeto para começar a gerenciar tarefas.</p>
              </div>
            ) : (
