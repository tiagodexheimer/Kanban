...
- [x] **Time Tracking**: Cronômetro integrado para registro de tempo por tarefa. Botão de "Play/Pause" dentro do card para registrar o tempo gasto na tarefa.
- [x] **Carga de Trabalho**: Visualização da distribuição de tarefas entre membros. Um gráfico que mostra quantas tarefas cada membro da equipe tem atribuídas para evitar sobrecarga.
- [x] **Exportação de Relatórios**: Gerar PDFs ou CSVs com o tempo gasto e tarefas concluídas no período.
